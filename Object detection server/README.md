...
!keras_retinanet/bin/train.py --freeze-backbone --random-transform --weights ./snapshots/_pretrained_model.h5 --batch-size 1 --epochs 10 csv annotations.csv classes.csv